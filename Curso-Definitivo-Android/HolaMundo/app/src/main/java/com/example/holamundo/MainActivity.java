...
import com.example.holamundo.modelo.Alumno;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        alumno.setNombre("Elioth");
        alumno.setFechaNacimiento(new Date());
        alumno.setNumeroCuenta(123456789);
    ...
    public void enviarDatos(View view){
        EditText edtNombre = findViewById(R.id.nombre);
        String nombre=edtNombre.getText().toString();

        //Ahora trabajamos con el toast
